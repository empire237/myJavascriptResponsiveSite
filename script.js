...
const allArticlesBtnContainer = document.querySelector(
...
const articles = [
  ...
  },
  {
    ...
    price: "0.00",
    content:
      "Bootstrap is a widely-used front-end framework for web development. It provides a collection of pre-designed HTML, CSS, and JavaScript components that simplify the process of building responsive and mobile-friendly websites. Bootstrap helps developers save time and maintain consistent design across web projects.",
    tag: "htmlcss",
  },
  {
    title: "TAILWIND",
    ...
    price: 0.99,
    content:
      "Tailwind CSS is a utility-first CSS framework that simplifies web development by providing a set of pre-defined classes that can be used to style web elements. It focuses on the composition of classes rather than writing custom CSS, making it highly customizable and efficient for creating responsive and visually appealing web designs.",
    tag: "htmlcss",
  },
];
...
function loadAllArticleItems(items) {
  ...
  const mainItemContainer = this.document.querySelector(
...
const animatedInputField = () => {
  ...
  const font = `${inputStyles.getPropertyValue(
    "font-size"
  )} ${inputStyles.getPropertyValue("font-family")}`;
  const paddingLeft =
    parseInt(inputStyles.getPropertyValue("padding-left"), 10) + 2;
  const paddingRight =
    parseInt(inputStyles.getPropertyValue("padding-right")) - 2;
  ...
  const caretIconUpdate = (arg) => {
    if (arg.length == 0) {
      caretEle.style.background =
        "linear-gradient(to top, rgb(210, 210, 219) 100%, rgb(200, 196, 196) 10%)";

      inputCounter.innerText = "0";
    } else if (arg.length == 1) {
      caretEle.style.background =
        "linear-gradient(to top, blue 10%, whitesmoke 10%)";

      inputCounter.innerText = "1";
    } else if (arg.length == 2) {
      caretEle.style.background =
        "linear-gradient(to top, blue 20%, whitesmoke 10%)";
      inputCounter.innerText = "2";
    } else if (arg.length == 3) {
      caretEle.style.background =
        "linear-gradient(to top, blue 30%, whitesmoke 10%)";
      inputCounter.innerText = "3";
    } else if (arg.length == 4) {
      caretEle.style.background =
        "linear-gradient(to top, blue 40%, whitesmoke 10%)";
      inputCounter.innerText = "4";
    } else if (arg.length == 5) {
      caretEle.style.background =
        "linear-gradient(to top, blue 50%, whitesmoke 10%)";
      inputCounter.innerText = "5";
    } else if (arg.length == 6) {
      caretEle.style.background =
        "linear-gradient(to top, blue 60%, whitesmoke 10%)";
      inputCounter.innerText = "6";
    } else if (arg.length == 7) {
      caretEle.style.background =
        "linear-gradient(to top, blue 70%, whitesmoke 10%)";
      inputCounter.innerText = "7";
    } else if (arg.length == 8) {
      caretEle.style.background =
        "linear-gradient(to top, blue 80%, whitesmoke 10%)";
      inputCounter.innerText = "8";
    } else if (arg.length == 9) {
      caretEle.style.background =
        "linear-gradient(to top, blue 90%, whitesmoke 10%)";
      ...
      caretEle.style.background =
        "linear-gradient(to top, blue 100%, whitesmoke 0.1%)";
